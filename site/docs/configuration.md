...
| `openApiSpecs` | `Array<{ name: string; url: string; order?: number }>` | - | Multiple OpenAPI specs rendered as sections on a single API page. Overrides `openApiUrl`. See [API Reference](/docs/api-reference). |
